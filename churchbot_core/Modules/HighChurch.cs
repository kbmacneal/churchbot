...
namespace churchbot.Modules.HighChurch {
    ...
    public class commands : ModuleBase<SocketCommandContext> {
        ...
        public async Task WelcomeAsync (SocketUser user) {
            ...
            await user.SendMessageAsync ("Welcome to the Church! Please review the pinned messages on the RP:FV discord to get caught up on the work that's been done so far. Another good resource is the website, http://highchurch.space. Use cb!commands to find out what else I can do!");
        }
